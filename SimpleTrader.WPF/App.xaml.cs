...
using SimpleTrader.FinanciaModelingPrepAPI.Services;
        ...
        public static IHostBuilder CreateHostBuilder(string[] args = null)
        {
            return Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddSingleton<IAuthenticationService, AutenticationService>();
                    ...
                    services.AddSingleton<IAccountStroe, AccountStore>();
